...
use macroquad::math::{DMat2, DVec2};
...
pub struct Sprites {
    ...
    sp_size: Vec<DVec2>, // Describes width, height of sprite, position is midpoint
...
impl Sprites {
    ...
    pub fn add_sprite(&mut self, pos: DVec2, sprite_type: SpriteType) {
        ...
        self.sp_size.push(DVec2::from((1.0, 1.0)));
        ...
        plane_scale: f64)
    {
        ...
        for sprite in self.sp_positions.iter() {
            ...
            if transform.y >= 0.0 {
                ...
                let sprite_width = (w / transform.y).abs();
                ...
                let sprite_height = (h / transform.y).abs();
